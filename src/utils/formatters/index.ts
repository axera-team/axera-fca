...
export { formatID, formatDate, formatCookie, _formatAttachment, formatAttachment, formatDeltaMessage, formatDeltaEvent, formatDeltaReadReceipt, getAdminTextMessageType }

export function formatMessage(m) {
    const originalMessage = m.message ? m.message : m;
    const obj: { // will fix this soon
      type: string;
      senderName: any;
      senderID: string;
