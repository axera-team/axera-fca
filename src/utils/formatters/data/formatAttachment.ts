...
export function getExtension(original_extension, fullFileName = "") {
...
// i forgot the exact data shapeof this, will go back next update
export function _formatAttachment(attachment1: Record<string, any> | null = null, attachment2: Record<string, any> | null = null) {
