...
import { _formatAttachment, formatDeltaMessage, formatDeltaEvent, formatDeltaReadReceipt } from "../formatters";
import { decodeClientPayload } from "../helpers";

/**
 * 
 * @param defaultFuncs Api Client
 * @param api api modules
 * @param ctx ctx
 * @param globalCallback 
 * @param v 
 * @returns 
 */
export function parseDelta(defaultFuncs, api, ctx, globalCallback, v) {
       ...
       // console.log(delta);
        if (delta.deltaMessageReaction && !!ctx.globalOptions.listenEvents) {
          ...
          var callbackToReturn: {
              ...
              timestamp: any;
              participantIDs: any;
              messageReply?: Record<string, any>;
          } = {
            type: "message_reply",
